...
void loop(void)
{
  ...
  {     
        ...
        sendTelemetry(temperature_reading);
        last_sent_time_ms = millis();
...
static void sendTelemetry(float payload)
{
  ...
  az_iot_hub_client_telemetry_get_publish_topic(
    ...
    getTelemetryPayload(telemetry, &telemetry, payload);
...
static void getTelemetryPayload(az_span payload, az_span* out_payload, float payloadValue)
{
